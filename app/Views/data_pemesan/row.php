<tr>
    ...
    <td align="center">
        <a href="<?= base_url(); ?>/data-pemesan/edit/<?= $row->id; ?>" class="btn btn-warning btn-circle btn-sm" title="Ubah Password">
            <i class="fas fa-pen"></i>
        </a>
        <a href="#" class="btn btn-success btn-circle btn-sm btn-change-group" data-id="<?= $row->id; ?>" title="Ubah Grup">
            <i class="fas fa-tasks"></i>
        </a>
        <a href="<?= base_url(); ?>/data-pemesan/detail/<?= $row->id; ?>" class="btn btn-info btn-circle btn-sm" title="Detail">
            <i class="fas fa-eye"></i>
        </a>
        <form action="/data-pemesan/<?= $row->id; ?>" method="post" class="d-inline">
            <?= csrf_field(); ?>
